...
fun main() {
//    solution7(intArrayOf(1,7,1,2))
    solution7(intArrayOf(1, 3, 4, 6))
}

fun solution7(food: IntArray): String {
    var answer: String = ""
    for (i in 1 until food.size) {
            val roof = food[i] / 2
            for (j in 0 until roof) {
                answer += i.toString()
            }
    }
...
//함수 알게된것
//repeat함수는 내가 원하는 만큼 반복할수있다. for문은 컬렉션이나 배열에 같이 많이 사용되나 repeat함수는 그럴필요가 없다
//StringBuilder()형태는 append()로 뒤에 쌓을수가 있다.
fun otherSolution7(food: IntArray): String {
